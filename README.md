# Baum Connes Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/baum-connes-conjecture-canonical-lane-mathlib.git
cd baum-connes-conjecture-canonical-lane-mathlib
lake exe
lake build
```
